...
handlers = [
    ...
    # articleSource
    url(r"/source/([0-9]+)/articles",
        controller.home.articleSourceHandler,
        name="articleSource"),
    # articleType
    url(r"/type/([0-9]+)/articles",
        controller.home.ArticleTypeHandler,
        name="articleType"),
    # article
    url(r"/article/([0-9]+)", controller.home.ArticleHandler, name="article"),
    url(r"/article/([0-9]+)/comment",
        controller.home.ArticleCommentHandler,
        name="articleComment"),
    # admin
    url(r"/admin/account",
        controller.admin.AdminAccountHandler,
        name="admin.account"),
    ...
    # admin.article_type
    url(r"/admin/articleType",
        controller.admin_article_type.AdminArticleTypeHandler,
        name="admin.articleTypes"),
    ...
    # admin.article
    url(r"/admin/article/(submit)",
        controller.admin_article.AdminArticleHandler,
        name="admin.article.action"),
    url(r"/admin/article",
        controller.admin_article.AdminArticleHandler,
        name="admin.articles"),
    url(r"/admin/article/([0-9]+)",
        controller.admin_article.AdminArticleHandler,
        name="admin.article"),
    url(r"/admin/article/([0-9]+)/(delete)",
        controller.admin_article.AdminArticleHandler,
        name="admin.article.update"),

    url(r"/admin/comment",
        controller.admin_article.AdminArticleCommentHandler,
        name="admin.comments"),
